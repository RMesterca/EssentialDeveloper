...
private extension NotebooksListViewController {
    ...
    func addNotebook(name: String) {
        ...
        notebookService.save(notebook: notebook)
    }

    func fetchNotebooks() {
        notebooks = notebookService.fetchNotebooks()
...
extension NotebooksListViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let aNotebook = notebooks[indexPath.row] else { return UITableViewCell() }
